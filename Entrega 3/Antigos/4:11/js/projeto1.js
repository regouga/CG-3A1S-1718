...
class Orange extends Object3D {
	constructor(x, y, z, materialOz, materialCC) {
		...
		this.lightMaterial = 0; //se estiver a zero, temos phong
		//this.basicMaterial = 0 //se estiver a 0 temos sem Basic
...
class Car extends Object3D {
	...
	changeMaterials(flagLetra) {
		...
		if (this.lightmaterial == 0) { //se tivermos um shadding phong
			...
			this.children[3].material = carMaterialsLambert[3];
			this.children[4].material = carMaterialsLambert[4];*/
		}
		else {
			this.lightmaterial = 0; //torna se em phong
			...
			this.children[3].material = carMaterialsPhong[3];
			this.children[4].material = carMaterialsPhong[4];*/
		}
	}
}
...
function createPerspectiveCamera() {
    ...
    cameraArray[1].position.y = 200;
    cameraArray[1].position.z = 200;
